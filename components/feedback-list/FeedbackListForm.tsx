...
const FeedbackListForm: React.FC = () => {
  ...
  const originalData: FeedbackData[] = [
    {
      id: 1,
      traineeName: "Nguyễn Văn A",
      subjectCode: "Java",
      rate: 5,
      openDate: "01/11/2024",
      lastUpdate: "02/11/2024",
    },
    {
      id: 2,
      traineeName: "Trần Văn B",
      subjectCode: "Python",
      rate: 4,
      openDate: "02/11/2024",
    ...
    {
      id: 3,
      traineeName: "Mã Đình Thị Thái H",
      subjectCode: "React",
      rate: 3,
      openDate: "03/11/2024",
    ...
    {
      id: 5,
      traineeName: "Đinh Thái M",
      subjectCode: "Python",
      rate: 5,
      openDate: "05/11/2024",
      lastUpdate: "06/11/2024",
    },
  ];
